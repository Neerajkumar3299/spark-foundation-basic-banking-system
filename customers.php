<?php
   ...
   //Import database connected file..
...
<head>
    ...
    <link rel="stylesheet" href="css/customers.css?<?php echo time(); ?>">
           ...
           <div class="section-data">
               ...
               <div class="section-table">
                    <table>
                        ...
                        <tr>
                            <td><?php echo $rows["uid"]."<br>";?></td>
                            <td><?php echo $rows["name"]."<br>";?></td>
                            <td><?php echo $rows["account_no"]."<br>";?></td>
                            <td><?php echo $rows["account_type"]."<br>";?></td>
                            <td><?php echo $rows["balance"]."<br>";?></td>
                            <td><a href="customers.php?delete_id=<?php echo $rows['uid']?>" id="delete">Delete</a></td>
