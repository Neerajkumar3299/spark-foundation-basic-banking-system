<?php
    include "_dbconnect.php";
        ...
        if(isset($_GET["id"])){
           ...
           $query="delete from transaction_history where tid=$id";
        ...
        <section class="section">
           <div class="section-data">
                ...
                ?>
                            ...
                            <td><?php echo $rows["receiever"];?></td>
                            <td><?php echo $rows["date_of_transaction"];?></td>
                            <td><?php echo $rows["amount"];?></td>
                            <td><a href="transactionHistory.php?id=<?php echo $rows['tid']?>">Delete</a></td>
